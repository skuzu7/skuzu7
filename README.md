...
|---|---|
| **[CSA-LAB](https://github.com/skuzu7/CSA-LAB)** | Reproducible AppSec lab. 3 documented findings (IDOR, SQLi, path traversal) with proof-of-concept tests, patched variants, and a passing regression suite. Localhost only. |
